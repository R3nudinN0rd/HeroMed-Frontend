            ...
            <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
                <form className="mb-4 md:flex md:flex-wrap md:justify-between" action="/" method="post" onSubmit={handleSubmit}>
                    <div className="flex flex-col mb-4 md:w-full">
                        ...
                        <input className="border rounded-full py-2 px-3 text-grey-darkest" type="text" name="title" id="section_title" onChange={handleChange}/>
                    </div>
                    <div className="flex flex-col mb-4 md:w-full">
                    ...
                    <div className="flex flex-col mb-4 md:w-full">
                        ...
                        <input className="border rounded-full py-2 px-3 text-grey-darkest" type="number" name="maximumEmployeesNo" id="employees_number" onChange={handleChange}/>
                    </div>
