...
function PatientRowComponent({ rowData }) {
    return (
        <>
            <div className='flex flex-col h-full w-full mt-2 mb-2'>
                <div className='flex flex-row w-full h-full'>
                    <div className='flex flex-col w-1/3 h-full'>
                        <span className='text-sm text-bold font-medium text-center opacity-50'>Patient name</span>
                        <span className='text-sm text-bold font-medium text-center'>{rowData.firstName} {rowData.lastName}</span>
                    </div>
                    <div className='flex flex-col w-1/3 h-full'>
                        <span className='text-sm text-bold font-medium text-center opacity-50'>Emergency contact</span>
                        <span className='text-sm text-vold font-medium text-center'>{rowData.emergencyContactName}</span>
                    </div>
                    <div className='flex flex-col w-1/3 h-full'>
                        <span className='text-sm text-bold font-medium text-center opacity-50'>Emergency phone no</span>
                        <span className='text-sm text-bold font-medium text-center'>{rowData.emergencyContactPhoneNumber}</span>
                    </div>
                </div>
...
export default PatientRowComponent